...
public:
    ...
    void SetAlbedoMap(const Ref<Tex>& albedoMap) { m_albedoMap = albedoMap; }
    void SetNormalMap(const Ref<Tex>& normalMap) { m_normalMap = normalMap; }
    void SetMetallicMap(const Ref<Tex>& metallicMap) { m_metallicMap = metallicMap; }
    void SetRoughnessMap(const Ref<Tex>& roughnessMap) { m_roughnessMap = roughnessMap; }
    void SetAoMap(const Ref<Tex>& aoMap) { m_aoMap = aoMap; }
    ...
    void Bind(Shader* overrideShader) const;
